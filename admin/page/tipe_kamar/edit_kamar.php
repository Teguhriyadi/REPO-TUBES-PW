...
<div class="details">
	<div class="recentOrders">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" id="tipe_kamar" placeholder="Masukkan Tipe Kamar" autocomplete="off" value="<?php echo $edit['tipe_kamar'] ?>">
		</div>
		<div class="form-group">
			<label for="deskripsi"> Deskripsi </label>
			<textarea class="form-control" id="deskripsi" placeholder="Masukkan Deskripsi" rows="5"><?php echo $edit['deskripsi'] ?></textarea>
		</div>
		<div class="form-group">
			<label for="fasilitas"> Fasilitas </label>
			<input type="text" class="form-control" id="fasilitas" placeholder="Masukkan Fasilitas" autocomplete="off" value="<?php echo $edit['fasilitas'] ?>">
		</div>
		<div class="form-group">
			<label for="harga"> Harga </label>
			<input type="number" class="form-control" id="harga" placeholder="0" autocomplete="off" value="<?php echo $edit['harga']; ?>">
		</div>
		<div class="form-group">
			<label for="jumlah_bed"> Jumlah Bed </label>
			<input type="number" class="form-control" id="jumlah_bed" placeholder="0" value="<?php echo $edit['jumlah_bed'] ?>">
		</div>
		<div class="form-group">
			<label for="ganti_gambar"> Ganti Gambar </label>
			<img src="../../../../../img/<?php echo $edit['image'] ?>">
		</div>
		<div class="form-group">
